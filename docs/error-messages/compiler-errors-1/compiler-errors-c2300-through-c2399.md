...
|エラー|Message|
|-----------|-------------|
|[コンパイラ エラー C2300](compiler-error-c2300.md)|'*class*': クラスに ' ~*class*' という名前のデストラクターがありません。|
|[コンパイラ エラー C2301](compiler-error-c2301.md)|'->~*identifier*' の左側はクラス、構造体、共用体を指す必要があります|
|[コンパイラ エラー C2302](compiler-error-c2302.md)|'. ~*identifier*' の左側にはクラス、構造体、共用体の型が必要です|
|コンパイラエラー C2303|構造化例外処理をコルーチンで使用することはできません|
|コンパイラエラー C2304|'*keyword*' は catch ブロックの内部では使用できません|
|コンパイラエラー C2305|'*file*' には、このモジュールのデバッグ情報が含まれていません|
|コンパイラエラー C2306|'*file*' には、このモジュールの最新のデバッグ情報が含まれていません|
|[コンパイラ エラー C2307](compiler-error-c2307.md)|インクリメンタルコンパイルが有効になっている場合、プラグマ *ディレクティブ* は関数の外に移動する必要があります|
|[コンパイラ エラー C2308](compiler-error-c2308.md)|一致しない文字列の連結|
|[コンパイラ エラー C2309](compiler-error-c2309.md)|catch ハンドラーには、かっこで囲まれた例外宣言が必要です|
|[コンパイラ エラー C2310](compiler-error-c2310.md)|catch ハンドラーは1つの型を指定する必要があります|
|[コンパイラ エラー C2311](compiler-error-c2311.md)|'*type*': '... ' によってキャッチされました行 *番号*|
|[コンパイラ エラー C2312](compiler-error-c2312.md)|'*type1*': 行 *番号**の '* type1 ' によってキャッチされました|
|[コンパイラ エラー C2313](compiler-error-c2313.md)|'*type1*': 行 *番号* の参照 *('* type1 ') によってキャッチされました|
|コンパイラエラー C2314|キーワード '*keyword1*' は非推奨です。代わりに '*keyword2*' を使用してください|
|[コンパイラ エラー C2315](compiler-error-c2315.md)|'*type1*': 行 *番号* の ' type1 *' に* よって参照がキャッチされました|
|[コンパイラ エラー C2316](compiler-error-c2316.md)|'*type*': デストラクターまたはコピーコンストラクターにアクセスできないか、削除されたため、キャッチできません|
|[コンパイラ エラー C2317](compiler-error-c2317.md)|'*number*' 行目で始まる ' try ' ブロックには catch ハンドラーがありません|
...
|[コンパイラ エラー C2320](compiler-error-c2320.md)|アクセス指定子 '*指定子*' の後には ': ' が必要です|
|コンパイラエラー C2321|'*identifier*' はキーワードであるため、このコンテキストでは使用できません|
|[コンパイラ エラー C2322](compiler-error-c2322.md)|'*identifier*': dllimport '*identifier*' のアドレスは静的ではありません|
|コンパイラエラー C2323|'*identifier*': 非メンバー演算子 new または delete 関数は、static として、またはグローバル名前空間以外の名前空間で宣言することはできません。|
|[コンパイラ エラー C2324](compiler-error-c2324.md)|'*identifier*': ':: ~ ' の右には予期されていません|
|[コンパイラ エラー C2325](compiler-error-c2325.md)|'*type1*'*: '-*>~ ' の右側に予期しない型があります: ' type1 ' が必要です|
|[コンパイラ エラー C2326](compiler-error-c2326.md)|'*宣言子*': 関数は '*identifier*' にアクセスできません|
|[コンパイラ エラー C2327](compiler-error-c2327.md)|'*identifier*': 型名、静的、または列挙子ではありません|
...
|[コンパイラ エラー C2364](compiler-error-c2364.md)|'*type*': カスタム属性の型が正しくありません。|
