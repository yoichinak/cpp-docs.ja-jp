...
|エラー|Message|
|-----------|-------------|
|コンパイラエラー C2000|不明なエラー。詳細については、Visual C++ のヘルプメニューからテクニカルサポートコマンドを選択するか、サポート情報ヘルプファイルを参照してください。|
|[コンパイラ エラー C2001](compiler-error-c2001.md)|定数の改行|
|[コンパイラ エラー C2002](compiler-error-c2002.md)|ワイド文字定数が無効です。|
|[コンパイラ エラー C2003](compiler-error-c2003.md)|' defined id ' が必要です|
|[コンパイラ エラー C2004](compiler-error-c2004.md)|'defined (id)' の形式にしてください。|
|[コンパイラ エラー C2005](compiler-error-c2005.md)|行番号が必要ですが、'*token*' が見つかりました #line|
|[コンパイラ エラー C2006](compiler-error-c2006.md)|'*ディレクティブ*': ファイル名が必要ですが、'*token*' が見つかりました。|
|[コンパイラ エラー C2007](compiler-error-c2007.md)|#define 構文|
|[コンパイラ エラー C2008](compiler-error-c2008.md)|'*character*': マクロ定義では予期されるものではありません|
|[コンパイラ エラー C2009](compiler-error-c2009.md)|マクロの仮引数 '*identifier*' を再利用します|
|[コンパイラ エラー C2010](compiler-error-c2010.md)|'*character*': マクロの仮パラメーターリストの中に予期しないものがあります。|
|[コンパイラ エラー C2011](compiler-error-c2011.md)|'*identifier*': '*type*' 型の再定義|
|[コンパイラ エラー C2012](compiler-error-c2012.md)|' < ' の後に名前がありません|
|[コンパイラ エラー C2013](compiler-error-c2013.md)|'>' がありません。|
|[コンパイラ エラー C2014](compiler-error-c2014.md)|プリプロセッサコマンドは最初のシャープ空白 space として起動する必要があります|
|[コンパイラ エラー C2015](compiler-error-c2015.md)|定数に文字が多すぎます|
|コンパイラエラー C2016|C では、構造体または共用体に少なくとも1つのメンバーが含まれている必要があります|
|[コンパイラ エラー C2017](compiler-error-c2017.md)|無効なエスケープシーケンスです。|
|[コンパイラ エラー C2018](compiler-error-c2018.md)|文字 ' 0x *value*' が不明です|
|[コンパイラ エラー C2019](compiler-error-c2019.md)|プリプロセッサディレクティブが必要ですが、'*character*' が見つかりました。|
|[コンパイラ エラー C2020](compiler-error-c2020.md)|'*member*': '*class*' メンバーの再定義|
|[コンパイラ エラー C2021](compiler-error-c2021.md)|'*character*' ではなく指数値が必要です|
|[コンパイラ エラー C2022](compiler-error-c2022.md)|'*number*': 文字に対して大きすぎます|
|コンパイラエラー C2023|'*identifier*': アラインメント (*number1*) が前の宣言 (*number2*) と異なります|
|コンパイラエラー C2024|' 整列 nas ' 属性は、変数、データメンバー、タグの種類にのみ適用されます|
|コンパイラエラー C2025|バイナリモジュールインターフェイスファイルが正しくないか破損しています: '*filename*'|
|[コンパイラ エラー C2026](compiler-error-c2026.md)|文字列が大きすぎます。末尾の文字が切り捨てられました|
|[コンパイラ エラー C2027](compiler-error-c2027.md)|未定義の型 '*type*' が使用されています。|
|[コンパイラ エラー C2028](compiler-error-c2028.md)|構造体や共用体のメンバーは、構造体か共用体の中になければなりません。|
|コンパイラエラー C2029|'*token*' の左側に未定義のクラス/構造体/インターフェイス '*identifier*' が指定されています|
|[コンパイラ エラー C2030](compiler-error-c2030.md)|アクセシビリティが 'protected private' であるデストラクターは、'sealed' として宣言されたクラスのメンバーになることはできません|
|コンパイラエラー C2031|*アクセシビリティが* アクセシビリティの仮想デストラクターは、この型では許可されていません|
|[コンパイラ エラー C2032](compiler-error-c2032.md)|'*identifier*': 関数を構造体/共用体 '*type*' のメンバーにすることはできません|
|[コンパイラ エラー C2033](compiler-error-c2033.md)|'*identifier*': ビットフィールドに間接参照を含めることはできません|
...
|[コンパイラ エラー C2070](compiler-error-c2070.md)|'*type*': sizeof オペランドが無効です。|
