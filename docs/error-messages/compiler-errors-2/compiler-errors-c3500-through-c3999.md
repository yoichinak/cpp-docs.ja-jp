...
|エラー|Message|
|-----------|-------------|
|[コンパイラ エラー C3500](compiler-error-c3500.md)|ProgID '*progid*' が無効です。|
|[コンパイラ エラー C3501](compiler-error-c3501.md)|ProgID '*progid*' に対して登録された typelib がありません|
...
|[コンパイラ エラー C3505](compiler-error-c3505.md)|タイプライブラリ '*library*' を読み込めません|
|[コンパイラ エラー C3506](compiler-error-c3506.md)|LIBID '*library*' に登録されている typelib はありません|
|[コンパイラ エラー C3507](compiler-error-c3507.md)|*progid は*、39文字以下でなければなりません。また、'. ' 以外の句読点を含めることもできません。または数字で始まらない|
|[コンパイラ エラー C3508](compiler-error-c3508.md)|'*type*': 有効なオートメーション型ではありません|
|[コンパイラ エラー C3509](compiler-error-c3509.md)|'*type*': オートメーションの戻り値の型が無効です。パラメーターが ' retval ' とマークされている場合、戻り値の型は ' void '、' HRESULT ' または ' SCODE ' である必要があります|
|[コンパイラ エラー C3510](compiler-error-c3510.md)|依存タイプライブラリ *ライブラリ* が見つかりません|
...
|[コンパイラ エラー C3519](compiler-error-c3519.md)|'*parameter*': embedded_idl 属性に対する無効なパラメーターです|
...
|[コンパイラ エラー C3638](compiler-error-c3638.md)|'*operator*': 標準のボックス化およびボックス化解除変換演算子を再定義することはできません|
...
|[コンパイラ エラー C3675](compiler-error-c3675.md)|'*function*': '*property*' が定義されているため、予約されています|
...
|[コンパイラ エラー C3712](compiler-error-c3712.md)|'*event_handler*': イベントハンドラーメソッドは、ソース '*event*' と同じ型を返す必要があります|
...
|[コンパイラ エラー C3749](compiler-error-c3749.md)|'*attribute*': カスタム属性を関数内で使用することはできません|
...
|[コンパイラ エラー C3860](compiler-error-c3860.md)|クラステンプレートまたはジェネリック名の後に続くテンプレートまたは汎用引数リストは、テンプレートまたはジェネリックパラメーターリストで使用されている順序でパラメーターを一覧表示する必要があります|
