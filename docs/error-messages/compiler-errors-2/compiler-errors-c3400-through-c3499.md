...
|エラー|Message|
|-----------|-------------|
|[コンパイラ エラー C3400](compiler-error-c3400.md)|'*constraint1*' と '*constraint2*' を含む、循環制約の依存関係です|
...
|[コンパイラ エラー C3408](compiler-error-c3408.md)|'*attribute*': テンプレート定義では属性は許可されていません|
|[コンパイラ エラー C3409](compiler-error-c3409.md)|空の属性ブロックは使用できません|
...
|[コンパイラ エラー C3413](compiler-error-c3413.md)|'*template*': 明示的なインスタンス化が無効です|
|[コンパイラ エラー C3414](compiler-error-c3414.md)|'*function*': インポートされたメンバー関数は定義できません|
|[コンパイラ エラー C3415](compiler-error-c3415.md)|異なる属性 (' 0x *value*') を持つ複数の '*section*' セクションが見つかりました|
|コンパイラエラー C3416|互換性のために残されています。|
|[コンパイラ エラー C3417](compiler-error-c3417.md)|'*宣言子*': 値型は、ユーザー定義の特殊メンバー関数を含むことはできません|
|[コンパイラ エラー C3418](compiler-error-c3418.md)|アクセス指定子 '*指定子*' はサポートされていません|
|コンパイラエラー C3419|互換性のために残されています。|
|[コンパイラ エラー C3420](compiler-error-c3420.md)|'*function*': ファイナライザーを仮想にすることはできません|
|[コンパイラ エラー C3421](compiler-error-c3421.md)|'*function*': このクラスのファイナライザーを呼び出すことはできません。アクセスできないか、存在しません。|
