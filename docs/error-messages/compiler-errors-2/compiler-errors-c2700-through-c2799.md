...
|エラー|Message|
|-----------|-------------|
|[コンパイラ エラー C2700](compiler-error-c2700.md)|'*type*': スローできません (詳細については/W4 を使用してください)|
|[コンパイラ エラー C2701](compiler-error-c2701.md)|'*function*': 関数テンプレートまたはジェネリックは、ローカルクラスの friend にすることはできません|
|[コンパイラ エラー C2702](compiler-error-c2702.md)| __except が終了ブロックに含まれていない可能性があります|
|[コンパイラ エラー C2703](compiler-error-c2703.md)|無効な __leave ステートメント|
|[コンパイラ エラー C2704](compiler-error-c2704.md)|'*function*': __va_start 組み込みは varargs でのみ許可されています。|
|[コンパイラ エラー C2705](compiler-error-c2705.md)|'*label*': '*exception_block*' スコープへのジャンプが正しくありません。|
|[コンパイラ エラー C2706](compiler-error-c2706.md)|一致する __try のない __except は無効です (__try ブロックに '} ' がありません)。|
|[コンパイラ エラー C2707](compiler-error-c2707.md)|'*identifier*': 組み込み関数のコンテキストが正しくありません|
|[コンパイラ エラー C2708](compiler-error-c2708.md)|'*identifier*': 実際のパラメーターのバイト数が前回の呼び出しまたは参照と異なっています|
|[コンパイラ エラー C2709](compiler-error-c2709.md)|'*identifier*': 仮引数のバイト数が前回の宣言と異なっています|
|[コンパイラ エラー C2710](compiler-error-c2710.md)|'*identifier*': ' __declspec (*修飾子*) ' は、ポインターを返す関数にのみ適用できます|
...
|コンパイラエラー C2727|互換性のために残されています。|
|[コンパイラ エラー C2728](compiler-error-c2728.md)|'*type*': ネイティブ配列にこの型を含めることはできません|
|コンパイラエラー C2729|互換性のために残されています。|
|[コンパイラ エラー C2730](compiler-error-c2730.md)|'*class*': それ自体の基底クラスにすることはできません|
